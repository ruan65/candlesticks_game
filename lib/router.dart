...
import 'package:card/candlesticks/play_candlestick_screen.dart';
...
final router = GoRouter(
  routes: [
    GoRoute(
      ...
      routes: [
        GoRoute(
          path: RouteName.candlesticks,
          pageBuilder: (context, state) => buildMyTransition(
            key: ValueKey('play'),
            color: context.watch<Palette>().backgroundPlaySession,
            child: const PlayCandlestickScreen(
              key: Key(RouteName.candlesticks),
            ),
          ),
          routes: [
            GoRoute(
